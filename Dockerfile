...
RUN native-image -cp ".:jar_files/*" --shared -H:Name=libbfbridge  --initialize-at-run-time=$(cat initialize-exceptions) --initialize-at-build-time org.camicroscope.BFBridge
RUN ls
